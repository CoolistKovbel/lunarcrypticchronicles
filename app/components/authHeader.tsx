  ...
  return (
    <div className="h-[20rem] w-full bg-transparent flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1 className="md:text-5xl text-3xl lg:text-8xl font-bold text-center text-white relative z-20">
        <Link href="/">LunarCrypticStation</Link>
      </h1>
      <div className="w-[40rem] h-40 relative">
        ...
        <div className="absolute inset-0 w-full h-[200px] bg-[#111] [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      </div>
    </div>
  );
}
